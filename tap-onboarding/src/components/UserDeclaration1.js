            ...
            <form class="w-full bg-white rounded shadow-2xl p-8 m-4 md:max-w-sm md:mx-auto">
                <Container component="main" maxWidth="xs">
                    <div>
                        ...
                        <div class= "pt-2 pb-1"> 
                            <p class="text-gray-500 text-sm text-center font-sans ">¿Sos una persona Expuesta Politicamente segun la nomina establicida en la Res. UIF N° 134/2018 y modificatorias?</p>
                        </div>
